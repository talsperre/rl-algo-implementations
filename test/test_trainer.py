...
parser.add_argument("--epsilon_decay", help="decay factor of epsilon", default=5e4, type=int)
...
writer = SummaryWriter(os.path.join(args.save_dir, 'runs', 'pong_experiment1'))
